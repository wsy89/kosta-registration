...
export class YouthKostaComponent implements OnInit {
  ...
  private loadSpeakers() {
    ...
    this.speakers.push(new Speaker('assets/img/speakers/Y_leewoongyong.png', '이웅용 강사', '', new Array<String>('거못 감리교회 담임목사','RUN & LEARN SPORTS ACADEMY 대표', '한국성서유니온선교회 COWORKER', '매일 성경 큐티 아이/청소년 매일 성경 집필진', 'EBS FOUNDER(EBCAMP, EXCAMP, EBSCHOOL)', 'ISC CYCAS KOREA CHIEF(INTERNATIONAL SPORTS COALITION CYCAS)')));
