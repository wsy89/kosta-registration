...
export class YouthKostaComponent implements OnInit {
  ...
  private loadSpeakers() {
    ...
    this.speakers.push(new Speaker('assets/img/speakers/YK_junghyemin.jpeg', '정혜민 강사', '', '브리지임팩트사역원 연구개발팀 간사. CTS 라디오 Joy "정혜민의 비빔톡" 진행. 경인여대 출강 (기독교개론)'));
    this.speakers.push(new Speaker('assets/img/speakers/YK_koeunsik.jpeg', '고은식 강사', '', '브리지임팩트사역원 공동대표. 도서출팔 BIM 대표'));
