...
export class YouthKostaComponent implements OnInit {
  ...
  private loadSchedules() {
    ...
    firstDay.push(new ScheduleItem('6:30 PM', '8:30 PM', '저녁 집회', '', '', 'fa-institution'));
    firstDay.push(new ScheduleItem('9:00 PM', '10:00 PM', '조별 모임', '', '', 'fa-users'));

    let secondDay: Array<ScheduleItem> = new Array<ScheduleItem>();
    secondDay.push(new ScheduleItem('7:30 AM', '8:30 AM', '아침 묵상', '', '', 'fa-users'));
    secondDay.push(new ScheduleItem('8:30 AM', '9:30 AM', '아침 식사', '', '', 'fa-cutlery'));
    secondDay.push(new ScheduleItem('9:30 AM', '10:50 AM', '성경 강해', '', '', 'fa-institution'));
    secondDay.push(new ScheduleItem('11:00 AM', '12:30 PM', '주제 강의', '', '', 'fa-institution'));
    ...
    secondDay.push(new ScheduleItem('4:30 PM', '5:30 PM', '조별 모임', '', '', 'fa-users'));
    secondDay.push(new ScheduleItem('5:30 PM', '6:30 PM', '저녁 식사', '', '', 'fa-cutlery'));
    secondDay.push(new ScheduleItem('6:30 PM', '8:30 PM', '저녁 집회', '', '', 'fa-institution'));
    secondDay.push(new ScheduleItem('9:00 PM', '10:00 PM', '조별 모임', '', '', 'fa-users'));

    let thirdDay: Array<ScheduleItem> = new Array<ScheduleItem>();
    thirdDay.push(new ScheduleItem('7:30 AM', '8:30 AM', '아침 묵상', '', '', 'fa-users'));
    thirdDay.push(new ScheduleItem('8:30 AM', '9:30 AM', '아침 식사', '', '', 'fa-cutlery'));
    thirdDay.push(new ScheduleItem('9:30 AM', '10:50 AM', '성경 강해', '', '', 'fa-institution'));
    thirdDay.push(new ScheduleItem('11:00 AM', '12:30 PM', '주제 강의', '', '', 'fa-institution'));
    ...
    thirdDay.push(new ScheduleItem('4:30 PM', '5:30 PM', '조별 모임', '', '', 'fa-users'));
    ...
    thirdDay.push(new ScheduleItem('10:00 PM', '11:00 PM', '조별 모임', '', '', 'fa-users'));

    let lastDay: Array<ScheduleItem> = new Array<ScheduleItem>();
    lastDay.push(new ScheduleItem('8:30 AM', '9:30 AM', '아침 식사', '', '', 'fa-cutlery'));
    lastDay.push(new ScheduleItem('9:30 AM', '10:50 AM', '성경 강해', '', '', 'fa-institution'));
    lastDay.push(new ScheduleItem('11:00 AM', '1:30 PM', '폐회 예배', '', '', 'fa-institution'));
